...
export const AttendanceWidget: React.FC = () => {
  ...
  useEffect(() => {
    // Force clear and reload data for demo
    ensureAttendanceRecords();
  }, [ensureAttendanceRecords, activeTerm?.id]);
  ...
  // Statistics - Use gamification streak for consistency
  const currentStreak = gamification.stats.attendanceStreak || getAttendanceStreak()
