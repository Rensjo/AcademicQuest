...
export function StudyHoursPanel({ isOpen, onClose }: StudyHoursPanelProps) {
  ...
  const analytics = useMemo(() => {
    ...
    // Use gamification store streak data instead of calculating locally
    const currentStreak = stats.streakDays
    const maxStreak = stats.longestStreak
  ...
  }, [periodSessions, dateRanges, selectedPeriod, stats.streakDays, stats.longestStreak])
